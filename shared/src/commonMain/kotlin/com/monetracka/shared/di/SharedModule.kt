...
fun sharedModule(): Module = module {
    ...
    single<com.monetracka.shared.domain.repository.ExchangeRateRepository> { com.monetracka.shared.data.repository.ExchangeRateRepositoryImpl(get()) }
    single<com.monetracka.shared.domain.repository.CategoryBudgetRepository> { com.monetracka.shared.data.repository.CategoryBudgetRepositoryImpl(get()) }
    single<com.monetracka.shared.domain.repository.RecurringTransactionRepository> { com.monetracka.shared.data.repository.RecurringTransactionRepositoryImpl(get()) }
